...
import static com.winapp.wmsSQLSJLite.activity.SalesOrderListActivity.shortCodeStr;
...
import com.winapp.wmsSQLSJLite.activity.GoodReceiptListActivity;
import com.winapp.wmsSQLSJLite.activity.SalesOrderListActivity;
import com.winapp.wmsSQLSJLite.model.GoodReceiptPreviewModel;
import com.winapp.wmsSQLSJLite.utils.Utils;

import java.util.ArrayList;

public class goodIssuePrintPreviewAdapter extends RecyclerView.Adapter<goodIssuePrintPreviewAdapter.ViewHolder> {

    private ArrayList<GoodReceiptPreviewModel.StockAdjustList> adjustLists;
    private Context context;
    View view;
    public goodIssuePrintPreviewAdapter(Context context, ArrayList<GoodReceiptPreviewModel.StockAdjustList> adjustList) {
